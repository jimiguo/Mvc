...
namespace Microsoft.AspNet.JsonPatch.Test
{
    public class ObjectAdapterTests
    {
        ...
        [Fact]
        public void AddIntListToGeneralList()
        {
            // Arrange
            var doc = new SimpleDTO()
            {
            ...
            // create patch
            var patchDoc = new JsonPatchDocument<SimpleDTO>();
            patchDoc.Add<int>(o => (List<int>)o.GeneralList, 4, 0);

            // Act
            patchDoc.ApplyTo(doc);

            // Assert
            Assert.Equal(new List<int>() { 4, 1, 2, 3 }, doc.GeneralList);
        }

        [Fact]
        public void AddIntListToGeneralListWithSerialization()
        {
            // Arrange
            var doc = new SimpleDTO()
            {
        ...
        public void AddStringListToGeneralList()
        {
            ...
            // create patch
            var patchDoc = new JsonPatchDocument<SimpleDTO>();
            patchDoc.Add<string>(o => (List<string>)o.GeneralList, "four", 0);

            // Act
            patchDoc.ApplyTo(doc);

            // Assert
            Assert.Equal(new List<string>() { "four", "one", "two", "three" }, doc.GeneralList);
        }
